...
it.layer(BaseTestLayer)("OrchestrationProjectionPipeline", (it) => {
  ...
  it.effect("clears stale pending pi user input from projected shell summaries", () =>
    Effect.gen(function* () {
      const projectionPipeline = yield* OrchestrationProjectionPipeline;
      const eventStore = yield* OrchestrationEventStore;
      const sql = yield* SqlClient.SqlClient;
      ...
      yield* appendAndProject({
        type: "project.created",
        eventId: EventId.make("evt-stale-pi-user-input-1"),
        aggregateKind: "project",
        aggregateId: ProjectId.make("project-stale-pi-user-input"),
        occurredAt: "2026-02-26T12:35:00.000Z",
        commandId: CommandId.make("cmd-stale-pi-user-input-1"),
        causationEventId: null,
        correlationId: CorrelationId.make("cmd-stale-pi-user-input-1"),
        metadata: {},
        payload: {
          projectId: ProjectId.make("project-stale-pi-user-input"),
          title: "Project Stale Pi User Input",
          workspaceRoot: "/tmp/project-stale-pi-user-input",
          defaultModelSelection: null,
          scripts: [],
          createdAt: "2026-02-26T12:35:00.000Z",
          updatedAt: "2026-02-26T12:35:00.000Z",
      ...
      yield* appendAndProject({
        type: "thread.created",
        eventId: EventId.make("evt-stale-pi-user-input-2"),
        aggregateKind: "thread",
        aggregateId: ThreadId.make("thread-stale-pi-user-input"),
        occurredAt: "2026-02-26T12:35:01.000Z",
        commandId: CommandId.make("cmd-stale-pi-user-input-2"),
        causationEventId: null,
        correlationId: CorrelationId.make("cmd-stale-pi-user-input-2"),
        metadata: {},
        payload: {
          threadId: ThreadId.make("thread-stale-pi-user-input"),
          projectId: ProjectId.make("project-stale-pi-user-input"),
          title: "Thread Stale Pi User Input",
          modelSelection: {
      ...
      yield* appendAndProject({
        type: "thread.activity-appended",
        eventId: EventId.make("evt-stale-pi-user-input-3"),
        aggregateKind: "thread",
        aggregateId: ThreadId.make("thread-stale-pi-user-input"),
        occurredAt: "2026-02-26T12:35:02.000Z",
        commandId: CommandId.make("cmd-stale-pi-user-input-3"),
        causationEventId: null,
        correlationId: CorrelationId.make("cmd-stale-pi-user-input-3"),
        metadata: {},
        payload: {
          threadId: ThreadId.make("thread-stale-pi-user-input"),
          activity: {
            id: EventId.make("activity-stale-pi-user-input-requested"),
            tone: "info",
            kind: "user-input.requested",
            summary: "User input requested",
            payload: {
              requestId: "user-input-request-stale-pi-1",
              questions: [
                {
                  id: "sandbox_mode",
                  header: "Sandbox",
      ...
      yield* appendAndProject({
        type: "thread.activity-appended",
        eventId: EventId.make("evt-stale-pi-user-input-4"),
        aggregateKind: "thread",
        aggregateId: ThreadId.make("thread-stale-pi-user-input"),
        occurredAt: "2026-02-26T12:35:03.000Z",
        commandId: CommandId.make("cmd-stale-pi-user-input-4"),
        causationEventId: null,
        correlationId: CorrelationId.make("cmd-stale-pi-user-input-4"),
        metadata: {},
        payload: {
          threadId: ThreadId.make("thread-stale-pi-user-input"),
          activity: {
            id: EventId.make("activity-stale-pi-user-input-failed"),
            tone: "error",
            kind: "provider.user-input.respond.failed",
            summary: "Provider user input response failed",
            payload: {
              requestId: "user-input-request-stale-pi-1",
              detail:
                "ProviderAdapterRequestError: Provider adapter request failed (pi) for extension_ui_response: Unknown pending pi user-input request: user-input-request-stale-pi-1",
            },
            turnId: null,
            createdAt: "2026-02-26T12:35:03.000Z",
          },
      ...
      const threadRows = yield* sql<{
        ...
        SELECT pending_user_input_count AS "pendingUserInputCount"
        FROM projection_threads
        WHERE thread_id = 'thread-stale-pi-user-input'
      `;
      assert.deepEqual(threadRows, [{ pendingUserInputCount: 0 }]);
    }),
  );

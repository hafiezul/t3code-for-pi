  ...
  WsRpcGroup.toLayer(
    Effect.gen(function* () {
      ...
      return WsRpcGroup.of({
        ...
        [WS_METHODS.serverPiGetSettingsFile]: (_input) =>
          observeRpcEffect(WS_METHODS.serverPiGetSettingsFile, piSettingsFile.read(), {
            "rpc.aggregate": "server",
          }),
        [WS_METHODS.serverPiUpdateSettingsFile]: (input) =>

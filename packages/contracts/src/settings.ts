...
export const PiSettings = makeProviderSettingsSchema(
  {
    ...
    launchArgs: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        providerSettingsForm: {
          placeholder: "e.g. --no-extensions",
          clearWhenEmpty: "omit",
        },
      }),
    ),
    // The five mainstream API keys pi reads from the environment. Injected
    // as env vars (ANTHROPIC_API_KEY, OPENAI_API_KEY, GEMINI_API_KEY,
    // GROQ_API_KEY, XAI_API_KEY) when set; all other pi-accepted keys ride
    // the per-instance environment-var editor.
    anthropicApiKey: TrimmedString.pipe(
      Schema.withDecodingDefault(Effect.succeed("")),
      Schema.annotateKey({
    ...
    openaiApiKey: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        description: "Injected as OPENAI_API_KEY for pi sessions.",
        providerSettingsForm: {
          control: "password",
          placeholder: "Optional",
          clearWhenEmpty: "omit",
    ...
    geminiApiKey: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        description: "Injected as GEMINI_API_KEY for pi sessions.",
        providerSettingsForm: {
          control: "password",
          placeholder: "Optional",
          clearWhenEmpty: "omit",
    ...
    groqApiKey: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Groq API key",
        description: "Injected as GROQ_API_KEY for pi sessions.",
        providerSettingsForm: {
          control: "password",
          placeholder: "Optional",
          clearWhenEmpty: "omit",
    ...
    xaiApiKey: TrimmedString.pipe(
      Schema.withDecodingDefault(Effect.succeed("")),
      Schema.annotateKey({
        title: "xAI API key",
        description: "Injected as XAI_API_KEY for pi sessions.",
        providerSettingsForm: {
          control: "password",
          placeholder: "Optional",
          clearWhenEmpty: "omit",
...
export const OmpSettings = makeProviderSettingsSchema(
  {
    ...
    launchArgs: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        ...
        providerSettingsForm: {
          placeholder: "e.g. --no-lsp",
          clearWhenEmpty: "omit",
        },
      }),
    ),
    // Per-instance OMP profile (`--profile <name>`): isolates auth,
    // sessions, settings, and caches. Empty = OMP's default profile.
    ...
    // The five mainstream API keys OMP reads from the environment. Injected
    // as env vars (ANTHROPIC_API_KEY, OPENAI_API_KEY, GEMINI_API_KEY,
    // GROQ_API_KEY, XAI_API_KEY) when set; all other OMP-accepted keys ride
    // the per-instance environment-var editor.
    anthropicApiKey: TrimmedString.pipe(
      Schema.withDecodingDefault(Effect.succeed("")),
      Schema.annotateKey({
    ...
    openaiApiKey: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "OpenAI API key",
        description: "Injected as OPENAI_API_KEY for omp sessions.",
        providerSettingsForm: {
          control: "password",
          placeholder: "Optional",
          clearWhenEmpty: "omit",
    ...
    geminiApiKey: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Google Gemini API key",
        description: "Injected as GEMINI_API_KEY for omp sessions.",
        providerSettingsForm: {
          control: "password",
          placeholder: "Optional",
          clearWhenEmpty: "omit",
    ...
    groqApiKey: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "Groq API key",
        description: "Injected as GROQ_API_KEY for omp sessions.",
        providerSettingsForm: {
          control: "password",
          placeholder: "Optional",
          clearWhenEmpty: "omit",
    ...
    xaiApiKey: TrimmedString.pipe(
      ...
      Schema.annotateKey({
        title: "xAI API key",
        description: "Injected as XAI_API_KEY for omp sessions.",
        providerSettingsForm: {
          control: "password",
          placeholder: "Optional",
          clearWhenEmpty: "omit",
...
const PiSettingsPatch = Schema.Struct({
  ...
  binaryPath: Schema.optionalKey(TrimmedString),
  launchArgs: Schema.optionalKey(TrimmedString),
  anthropicApiKey: Schema.optionalKey(TrimmedString),
  openaiApiKey: Schema.optionalKey(TrimmedString),
  geminiApiKey: Schema.optionalKey(TrimmedString),

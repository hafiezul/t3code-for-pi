...
The backend agent runtime that actually performs work. Seven drivers ship built in: Codex, Claude, Cursor, Grok, OpenCode, Pi, and OMP. See [ProviderService.ts][14], [ProviderAdapter.ts][15], and [CodexAdapter.ts][17] as a representative adapter.

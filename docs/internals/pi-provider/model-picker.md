...
| ---------- | --------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `thinking` | `yes` → `buildBooleanOptionDescriptor({ id: "thinking", label: "Thinking" })`; `no` → no descriptor | Exact Claude convention (`claude-haiku-4-5` in `ClaudeProvider.ts`); renders the "Thinking" cap label in `ProviderModelsSection`, ignored by the composer (it only picks up _select_ descriptors)                                            |
